<div class="card-inner">
    ...
    <div class="text-center mb-3">
        {if $public_setting['manual_qr_image_url'] !== ''}
        <img src="{$public_setting['manual_qr_image_url']}" alt="Mã QR thanh toán" class="img-fluid rounded"
             style="max-width: 240px;">
        {else}
        <div class="alert alert-warning mb-0">
            Chưa cấu hình ảnh QR. Vui lòng liên hệ quản trị viên.
        </div>
        {/if}
    </div>
    ...
    <div class="small">
        ...
        <div><strong>Nội dung chuyển khoản:</strong> INV{$invoice->id}</div>
    </div>
