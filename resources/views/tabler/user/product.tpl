            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <div class="page-pretitle my-3">
                        <span class="home-subtitle">Duyệt các sản phẩm bạn cần</span>
                    </div>
                </div>
            </div>
        </div>
                                                                ...
                                                                <div class="row align-items-center">
                                                                    <div class="col text-truncate">
                                                                        {if $tabp->content->speed_limit === '0'}
                                                                            <div class="text-reset d-block">Không giới hạn</div>
                                                                        {else}
                                                            ...
                                                            {if $tabp->stock === -1 || $tabp->stock > 0}
                                                                <div class="col">
                                                                    <a href="/user/order/create?product_id={$tabp->id}"
                                                                       class="btn btn-primary w-100 my-3">Mua</a>
                                                                </div>
                                                            {else}
                                                                <div class="col">
